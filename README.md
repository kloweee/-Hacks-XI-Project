...
2. Go to [chrome://extensions/]([chrome://extensions/](url)) and make sure "Developer Mode" is turned on.
3. Upload `Extension` to [chrome://extensions/]([chrome://extensions/](url)) using "Load unpacked".
